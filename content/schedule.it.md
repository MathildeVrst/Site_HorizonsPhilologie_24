...
tab:
  ...
  - name : "Giorno 01"
    ...
    - speaker :
      pause : "[SESSIO I] Paleografia, HTR e ricostruzione virtuale"
      subject :
      abstract :
      biografia :
      venue :
    ...
    - speaker : "Gustavo Fernandez (Ruprecht-Karls-Universität Heidelberg. University Library ; Collaborative Research Center 933 ‘Material Text Cultures’)"
      ...
      abstract: "L'analisi del layout è il processo computazionale con cui vengono identificate e categorizzate le differenti regioni di un'immagine scansionata. È una fase importante di qualsiasi flusso di lavoro per il riconoscimento del testo manoscritto. A seconda del documento, le zone di interesse possono essere di natura diversa (ad esempio colonne e righe). In questa presentazione mostrerò come l'analisi del layout possa essere utilizzata per creare allineamenti testo-immagine in edizioni digitali di fonti manoscritte. L'allineamento mette in relazione il testo digitale dattiloscritto, che per la maggior parte mantiene le convenzioni di impaginazione dell'epoca della stampa meccanica, con la superficie diversa e ricca di caratteristiche delle fonti manoscritte. In quanto esempio concreto, presenterò gli attuali sviluppi dell'Università di Heidelberg, in particolare della rivista scientifica *Pylon: Editions and Studies of Ancient Texts*. Sosterrò che l'allineamento testo-immagine è uno strumento utile non solo nelle edizioni di documenti antichi e di difficile lettura, ma anche nel caso di qualsiasi documento con un layout complesso."
      biografia : "Gustavo Fernández Riva è ricercatore associato in Digital Humanities presso la Biblioteca Universitaria di Heidelberg e si occupa principalmente di sviluppo tecnico e concettuale nel campo del Digital Editing. Ha conseguito un dottorato di ricerca in letteratura comparata presso l'Università di Buenos Aires nel 2018. I suoi principali campi di ricerca sono le pratiche scritte e letterarie nelle società non tipografiche. I suoi attuali progetti di ricerca includono l'utilizzo dell'analisi di reti per lo studio della trasmissione manoscritta condivisa di testi medievali e la creazione di un dataset aperto e collaborativo di *stemmata* filologici."
      venue : "da determinare"
      time : "10h30 - 11h00"
    ...
    - speaker : "Maxime Guénette (Università di Montréal, dottorando)"
      ...
      abstract: "Alla luce dei progressi tecnologici degli ultimi anni, l'interesse per il riconoscimento della scrittura manoscritta (HTR, Handwritten Text Recognition) è in costante crescita nel mondo accademico. Si tratta di una tecnologia particolarmente promettente : grazie all'addestramento di modelli in grado di riconoscere la grafia dei documenti storici, possiamo accedere più facilmente al nostro passato. Nel corso della presentazione, osserveremo come questa tecnologia derivata dall'intelligenza artificiale e dall'apprendimento profondo viene applicata al greco antico. A partire dal caso studio del *Codex Palatinus graecus 23* (il manoscritto principale fornito dall'*Antologia Palatina*), presenteremo la metodologia necessaria per addestrare un modello HTR in grado di riconoscere il greco antico, le difficoltà intrinseche di questa lingua e delle lingue non latine e le possibili soluzioni esplorate nell'ambito del progetto di edizione digitale collaborativa dell'*Antologia greca*."
      biografia : "Maxime Guénette è dottorando in storia presso l'Università di Montreal. La sua ricerca si interessa della religione nell'Impero romano, della sacralità dello spazio e della globalizzazione antica. Dal 2020 è editore della piattaforma *Anthologia Graeca*, all'interno del quale si è occupato di aggiungere traduzioni in inglese e francese di epigrammi, parole chiave che identificano figure e luoghi storici e commenti filologici. Recentemente è stato coinvolto nel progetto IAL (Literary Artificial Intelligence) per identificare le variazioni letterarie presenti nel corpus di epigrammi dell'*Antologia greca*. Nell'ambito di uno stage presso la Chaire de recherche du Canada sur les écritures numériques nel trimestre estivo 2023, ha esplorato l'applicazione dell'HTR (Handwritten Text Recognition) al *Codex Palatinus graecus 23* utilizzando la piattaforma eScriptorium. Lo stage ha portato allo sviluppo di modelli in grado di riconoscere il greco antico all'interno di manoscritti medievali come l'*Anthologie Palatine*."
      venue : "da determinare"
      time : "11.00 - 11.30"
    ...
    - speaker : "Marianne Reboul (École Normale Supérieure de Lyon, Institut d'histoire des représentations et des idées dans la modernité)"
      ...
      abstract: "Allineare i testi originali e le loro traduzioni in diverse lingue è fondamentale per capire come i testi antichi siano diventati materia essenziale per il nostro patrimonio culturale. Le recenti innovazioni nei modelli linguistici massivi ci permettono di comprendere l'evoluzione del modo in cui i testi antichi sono stati compresi fino ai giorni nostri. È ora possibile, con una quantità minima di dati di addestramento paralleli, calcolare equivalenze semantiche tra più lingue contemporaneamente per le lingue moderne. Ma è anche possibile perfezionare questi modelli esistenti per le lingue antiche. In questo intervento vedremo come i modelli multilingue perfezionati possano essere applicati alle lingue antiche per costruire metriche di somiglianza e favorire un migliore allineamento tra un testo di partenza e la sua traduzione. Come caso d'uso, allineeremo testi filosofici classici in latino e greco a traduzioni moderne in francese dal XVIII secolo al XX secolo."
      biografia : "Marianne Reboul è docente di Digital Humanities presso l'École Normale Supérieure di Lione, specializzata in Digital Humanities e Classici, più precisamente *classici digitali*. Lavora in particolare sull'applicazione delle tecniche di intelligenza artificiale alle lingue antiche."
      venue : "da determinare"
      time : "13.00 - 13.30"
  ...
  - name : "Giorno 02"
    ...
    - speaker :
      pause : "[SESSIO II] Filologia collaborativa"
      subject :
      abstract :
      biografia :
      venue :
    ...
    - speaker : "Marta Legnini (Università degli Studi di Parma, dottoranda)"
      ...
      abstract : "Il presente contributo illustra l'integrazione della piattaforma *Anthologia graeca* (attraverso l'aggiunta di traduzioni, commenti e note bibliografiche) nell'ambito di uno studio filologico sugliepigrammi 'anacreontei' dell'Antologia Palatina. Si porrà l'accento sulle scelte operate nel passaggio dall'edizione cartacea a quella digitale e sulle opportunità scientifiche e divulgative offerte da un progetto di \"filologia collaborativa\" basato su contributi specialistici."
  ...
  - name : "Giorno 03"
    ...
    - speaker :
      pause : "[SESSIO III] Epistemologia del testo: edizioni critiche di testi classici"
      subject :
      abstract :
      biografia :
      venue :
    ...
    - speaker : "Robert Alessi (CNRS, UMR 8167 Orient & Méditerranée)"
      ...
      abstract : "Sia che l'edizione critica venga realizzata in formato digitale o cartaceo, deve preservare la forma tradizionale del apparatus criticus ereditata da oltre due secoli di tradizione continua. Lo intendiamo come un paragrafo scritto in latino con sfumature ed economia di stile. Sebbene questo stile di scrittura sia immediatamente accessibile all'intelligenza umnana, rimane incomprensibile dalle macchine. In questo workshop verrà mostrato tramite esempi concreti come ‘ekdosis’ possa essere utilizato come punte di inizio in una catena editoriale a “single source publishing”. Partendo da un codice sorgente simplice ma strutturato, si può richiedere a ‘ekdosis’ di compilare in una singola operazione due output completamente diversi: il primo destinato alla pubblicazione stampata tradizionale con note critiche redatte *in toto* e il secondo sotto forma di database TEI xml direttamente interpretabile dalle macchine."
      biografia : "Robert Alessi è ricercatore presso l'Unità di ricerca congiunta del CNRS “Orient & Méditerranée” (UMR 8167, Parigi, Francia). La sua ricerca si concentra sull'edizione dei testi medici greci e arabi, sulla storia della medicina, ma anche sull'informatica applicata agli studi classici."
      venue : "da determinare"
      time : "15.30 – 17.30"
